...
#
# Python script my-qkd-ibm-with-eve-hw.py
...
# Based on the connection example from https://qiskit.org/documentation/stubs/qiskit.providers.ibmq.IBMQBackend.html
#
# Creation Date: 23/03/2022
# Updates:
# 23/03/2022 - Modify to use the quaternion files as binary input. 
# 24/03/2022 - Modify the connection to use the actual IBM Quantum machine instead of a simulator.
# 
...
# Login into IBMQ
IBMQ.save_account('e423636e', overwrite=True)
provider = IBMQ.load_account()

# Creating registers with n qubits (the ibmq_lima has a limmit of 5 qubits)
n = 4
...
# Reduce to 4 bits for the test with real quantumm computers due to the limitation
alice_key=alice_key[0:4]
